...
def compress_stage(T_in_C, P_in_bar, P_out_bar, mass_flow, x_o2, x_n2, eta_isen, eta_mech):
    ...
    # Power calculation (mass flow in kg/s) including mechanical efficiency
    power_W = mass_flow * cp * (T_out_K - T_in_K) / eta_mech
...
def generate_table(final_pressure):
    ...
    for vol_in in inlet_flows:
        ...
        T_out_1, power_1, mass_flow_1, _ = compress_multi_stage(
            ...
            stages_1_table, o2_frac, n2_frac, eta_isentropic, eta_mech
        )
        ...
        T_out_2, power_2, mass_flow_2, _ = compress_multi_stage(
            ...
            stages_2_table, o2_frac, n2_frac, eta_isentropic, eta_mech
        )
